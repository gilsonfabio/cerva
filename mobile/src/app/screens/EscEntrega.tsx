...
export default function EscEntrega(){
    ...
    return(
        <View className="flex-1 items-center bg-white">
            <View className="flex-row w-full h-20 bg-sky-900 ">

            </View>        
            <View className="flex w-full items-center justify-center">
                <Text className="text-xl text-black font-semibold ">Escolha endereço para entrega</Text>
            </View>    
            ...
            <View className="flex-col items-center w-full mt-40">
                <TouchableOpacity onPress={handleNewLocalizacao} className='w-full h-20 '>
                    <View className="flex items-center justify-center bg-violet-900 w-96 h-48 rounded-md">
